                ...
                <div className="mainBlock">
                    ...
                    <div className="textBlock" >
                        ...
                        <div className="box" id='1'>
                            <h1>Annuity Payment Description</h1>
                            <h2>
                        ...
                        <div  className="box" id='2'>
                            <h1>Simple Payment Description</h1>
                            <h2>
                        ...
                        <div className="box" id='3'>
                            <h1>Differentiated Payment Description</h1>
                                <h2>Differentiated payment (DP) is a type of payment used when a financial institution creates a loan repayment scheme. </h2>
